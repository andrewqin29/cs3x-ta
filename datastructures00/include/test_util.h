 ...
 */
bool strarray_eq(packed_strarray_t *arr1, packed_strarray_t *arr2);
 ...
 */
bool strarray_matches(packed_strarray_t *arr, const char *expected[], size_t length);
/**
 ...
 */
bool strarray_set_matches(packed_strarray_t *arr, const char *expected[], size_t length);
/**
...
/**
 * Returns a packed_strarray_t from an array of strings, duplicating the strings.
 * 
 * The number of strings must be passed as the second argument.
 */
packed_strarray_t *strarray_from_array(const char *arr[], size_t length);

/**
 * Returns a packed_strarray_t from a variable number of strings, duplicating the strings.
 */
